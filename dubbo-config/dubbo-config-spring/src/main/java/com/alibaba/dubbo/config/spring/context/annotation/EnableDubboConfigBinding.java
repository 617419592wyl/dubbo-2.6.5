 ...
 * @since 2.5.8
 * 从属性启用Spring的注解驱动的Dubbo配置。
默认情况下，prefix()与属性前缀e、g关联。“dubbo.application。”或者“dubbo.application”
 */
...
public @interface EnableDubboConfigBinding {
    ...
    /**
     * The name prefix of the properties that are valid to bind to {@link AbstractConfig Dubbo Config}.绑定到Dubbo配置的有效属性的名称前缀。
     *
    ...
    /**
     * It indicates whether {@link #prefix()} binding to multiple Spring Beans.它指示prefix()是否绑定到多个Spring bean。
     *
