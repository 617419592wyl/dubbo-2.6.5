 ...
 * @since 2.5.8
 * 默认行为下的一个方便的多EnableDubboConfigBinding，等于一个bean绑定，属性前缀约定如下
 * 相反，对于需要将multiple()设置为true的多个bean绑定:
 */
...
public @interface EnableDubboConfig {
    ...
    /**
     * It indicates whether binding to multiple Spring Beans.它指示是否绑定到多个Spring bean。
     *
