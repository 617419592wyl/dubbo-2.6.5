...
public class DubboRegistry extends FailbackRegistry {
    ...
    // The lock for client acquisition process, lock the creation process of the client instance to prevent repeated clients 锁定客户端获取过程，锁定客户端实例的创建过程，防止客户端重复
    ...
    /**
     * The time in milliseconds the reconnectTimer will wait reconnectTimer将等待的时间(以毫秒为单位)
     */
