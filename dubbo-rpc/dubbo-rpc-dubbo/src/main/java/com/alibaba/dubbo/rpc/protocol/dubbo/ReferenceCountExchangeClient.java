...
//        HeaderExchangeClient.request(java.lang.Object, int)
    ...
    private LazyConnectExchangeClient replaceWithLazyClient() {
        // this is a defensive operation to avoid client is closed by accident, the initial state of the client is false 这是一种防御性操作，避免客户端意外关闭，客户端初始状态为false
        ...
        // in worst case there's only one ghost connection.在最坏的情况下，只有一个ghost连接。
