...
public class RpcStatus {
    ...
    /**
     * Semaphore used to control concurrency limit set by `executes` 用于控制由“execute”设置的并发限制的信号量
     */
    ...
    /**
     * Get the semaphore for thread number. Semaphore's permits is decided by {@link Constants#EXECUTES_KEY} 获取线程号的信号量。信号量的许可由constant . executes_key决定
     *
